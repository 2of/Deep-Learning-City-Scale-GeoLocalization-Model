...
def main(batch_size):
    ...
    for i in range(num_batches):
        ...
        for index, row in images_df.iterrows():
            ...
            # Initialize lists to hold non-empty tensors
            class_names_vectors = []
            bboxes_vectors = []
            confidences_vectors = []

            # Add non-empty tensors to the lists
            ...
            # Stack the non-empty tensors using TensorFlow
            ...
            # # print(stacked_confidences.shape)
            # # print(colour_embedding.shape)
            # # print(text_embedding.shape)
            # # print(colour_embedding.shape)
            # # Add to lists for TFRecord
    ...
    # Save to TFRecord
        tfrecord_filename = os.path.join(OUT_TF_RECORDS_DIR, f"output_{i}.tfrecord")
