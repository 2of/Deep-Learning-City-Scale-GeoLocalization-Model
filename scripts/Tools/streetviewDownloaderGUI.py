...
from PyQt5.QtWidgets import QFileDialog, QTableWidgetItem, QMessageBox, QTextEdit
...
class StreetViewDownloaderApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 800, 600)  # Adjusted window size for additional widgets
        ...
        self.main_layout.addWidget(self.api_key_entry)

    
        self.download_directory_label = QtWidgets.QLabel("Download Directory")
        self.main_layout.addWidget(self.download_directory_label)
        ...
        self.main_layout.addWidget(self.tabledata)
        ...
        self.main_layout.addWidget(self.url_button)
